...
\begin{itemize}
 ...
 \end{itemize}
 \item Following are the results of applying the predictions to training data itself. Each row specifies the distribution of the samples belonging to a specific class.\ref{tab-confusion-vsm}).
\end{itemize}
\begin{center}
	\begin{figure}[ht!]
...
\begin{table}[ht!]
  ...
  \hline
  \textbf{anger} & 1502 & 349 & 312 & 69.4 \\
  \textbf{sadness} & 247 & 1501 & 405 & 69.7 \\
  \textbf{joy} & 26 & 61 & 1005 & 92.0 \\
  \end{tabular}
...
\begin{table}[ht!]
  ...
  & \textbf{anger} & \textbf{sadness} & \textbf{joy} & \emph{Accuracy \%}\\
  \hline
  \textbf{anger} & 2100 & 56 & 7 & 97.1 \\
  \textbf{sadness} & 57 & 2077 & 19 & 96.5 \\
  \textbf{joy} & 8 & 14 & 1070 & 97.9 \\
  \end{tabular}
...
\begin{table}[ht!]
  ...
  & \textbf{anger} & \textbf{sadness} & \textbf{joy} & \emph{Accuracy \%}\\
  \hline
  \textbf{anger} & 1615 & 406 & 142 & 74.6 \\
  \textbf{sadness} & 5 & 1790 & 358 & 83.1 \\
  \textbf{joy} & 0 & 1 & 1091 & 99.9 \\
  \end{tabular}
